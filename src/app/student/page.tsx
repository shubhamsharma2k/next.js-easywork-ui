...
import PersonalInformation from "@/app/components/Students/PersonalInformation";
import FeesAndPaymentInformation from "@/app/components/Students/FeesAndPaymentInformation";
...
const StudentView = () => {
	...
	const {getMetadataOnRefresh} = useStoreActions((action)=>action.misc)
	...
	const handleFetch = async () => {
		const rsp = await getMetadataOnRefresh();
